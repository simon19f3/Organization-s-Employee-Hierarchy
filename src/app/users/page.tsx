...
export default function Simon(){
   const skills:any=[{name:'Machine Learning',description: 'Supervised learning, Unsupervised learning'},
    ...
    return(
        <div>
        <div className='text-center text-7xl mt-8'>CEO PAGE</div>
    ...
    <div className='space-y-10  px-20 ' >
        ...
        <Link className="bg-blue-950 rounded-md p-2 text-blue-100" href="users/cfo">CFO</Link>
        <Link className="bg-blue-950 rounded-md p-2 text-blue-100" href="users/hr">HR</Link>
        <Link className='bg-blue-950 rounded-md p-2 text-blue-100' href='users/profileEditing'>Profile</Link>
        </div>
        </div> 
        </div>  
    )
